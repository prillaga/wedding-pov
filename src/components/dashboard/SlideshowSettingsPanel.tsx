      ...
      <section className="p-4 rounded-2xl bg-white wedding-shadow border border-champagne/10 space-y-3">
        ...
        <label className="flex items-center gap-2 text-sm">
          <input
            ...
            onChange={(e) => patch({ music: { ...slideshow.music, enabled: e.target.checked } })}
          />
        ...
        <label className="flex items-center gap-2 text-sm">
          <input
            ...
            onChange={(e) => patch({ music: { ...slideshow.music, loop: e.target.checked } })}
          />
          Loop music
        </label>
        <label className="flex items-center gap-2 text-sm">
          <input
            ...
            onChange={(e) => patch({ music: { ...slideshow.music, autoFade: e.target.checked } })}
          />
          Auto-fade between tracks
        </label>
        <Input
          label="Track Name (display only)"
          defaultValue={slideshow.music.trackName ?? ""}
          placeholder="Canon in D"
          onBlur={(e) =>
            patch({ music: { ...slideshow.music, trackName: e.target.value || undefined } })
          }
        />
      </section>
    </div>
